...
export declare const getLegendDataForKeys: <RawDatum extends BarDatum>(bars: BarsWithHidden<RawDatum>, layout: NonNullable<"horizontal" | "vertical" | undefined>, direction: BarLegendProps['direction'], groupMode: NonNullable<"grouped" | "stacked" | undefined>, reverse: boolean, getLegendLabel: (datum: LegendLabelDatum<RawDatum>) => string) => LegendData[];
