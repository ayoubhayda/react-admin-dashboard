...
import { Box, Dimensions, MotionProps, Theme, PropertyAccessor, StackOrder, StackOffset, AreaCurve, SvgDefsAndFill, ValueFormat } from '@nivo/core';
...
export type StreamSvgProps<RawDatum extends StreamDatum> = Partial<StreamCommonProps<RawDatum>> & StreamDataProps<RawDatum> & SvgDefsAndFill<StreamLayerData> & Dimensions & MotionProps;
